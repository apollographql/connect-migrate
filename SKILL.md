...
license: Elastic-2.0
compatibility: Requires the connect-migrate CLI on PATH. Install the prebuilt binary with install.sh, or build it from the upstream router source when policy forbids downloaded binaries. Works with Claude Code and similar AI coding assistants.
---
