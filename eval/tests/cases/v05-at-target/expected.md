...
<!-- no-ops: 0 -->
<!-- questions: 0 -->
<!-- upgrade: connect/v0.5 -> connect/v0.4 -->
<!-- parse-notices: 0 -->
<!-- schemas-skipped: 0 -->
...
**Upgrade:** `connect/v0.5` (1 schema). Every scanned schema already links `connect/v0.4` or newer, so there is nothing to migrate.

**Scope:** project root `schemas` · 1 `.graphql` file · 1 `@connect` directive analyzed.

Schemas considered: `catalog-v05.graphql`
